...
def main():
    ...
    map_using_coord = subparsers.add_parser("map-using-coord", help="Generate edit maps using genetic coordindates of bim entry")
    map_using_coord.set_defaults(func=snptk.app.map_using_coord)

    map_using_coord.add_argument("--bim-offset", type=int, default=0)
    map_using_coord.add_argument("-d", "--dbsnp", required=True)
